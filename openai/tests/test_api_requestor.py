...
#     Model.retrieve("gpt-3.5-turbo", request_id=fake_request_id)  # arbitrary API resource
...
#     mocker.patch("openai.api_requestor.init_session", lambda: mock_session)
#
...
#     mocker.patch("openai.api_requestor.init_session", lambda: mock_session_2)
#     api_requestor.request_raw("get", "http://example.com")
